...
public class FullWeatherApiControllerTests {
	...
	public void testGetByIPShouldReturn400BadRequestBecauseGeolocationException() throws Exception
	{
		...
		Mockito.when(locationService.getLocation(anyString())).thenThrow(ex);
	...
	public void testGetByCodeShouldReturn404NotFound() throws Exception {
		...
		when(weatherService.getByCode(locationCode)).thenThrow(ex);
	...
	public void testGetByCodeShouldReturn200OK() throws Exception {
		...
		when(weatherService.getByCode(locationCode)).thenReturn(location);
